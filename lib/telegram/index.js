        ...
        const system =
            ...
            (owner
                ? '7. User (SUAMI/OWNER) minta jalankan perintah terminal/shell server → {"action":"exec","cmd":"<perintah shell>"}\n' +
                  ...
                  '15. User kirim zip dan minta lihat isinya → {"action":"read_zip"} (otomatis diproses)\n'
    ...
    async _handleZipFile(msg, chatId) {
        ...
        try {
            ...
            return this.tg.sendMessage(chatId,
                ...
                `Mau extract? Bilang "extract zip" ya. Mau baca salah satu file? Bilang nama filenya.`);
        } catch (e) {
