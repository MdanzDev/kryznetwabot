...
class Humanizer {
    ...
    splitResponse(text, moodMaxParts = 10) {
        // Respect mood caps: sleepy/busy = 1-2, chatty moods = 10.
        // The AI's own structure (paragraphs/sentences) drives the split;
        // the cap only prevents over-splitting in quiet moods.
        ...
        // 2. Single newlines — only if no double-newline splits found
