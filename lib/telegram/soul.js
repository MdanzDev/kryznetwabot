...
const MOODS = {
    cheerful: {
        ...
        maxLen: 3,        // max messages in a split
        emojiBias: 0.15,  // higher = more emoji
...
class Soul {
    ...
    contextBlock(userId) {
        ...
        let timeTone = "";
        if (hour >= 23 || hour < 6) timeTone = "SEKARANG LARUT MALAM — kamu sangat ngantuk, jawab SANGAT singkat, nada sleepier dari biasanya.";
