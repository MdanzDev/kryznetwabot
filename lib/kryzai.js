...
async function chatWithAI(prompt) {
    ...
    const apiUrl = "https://omegatech-api.dixonomega.tech/api/ai/chatgpt-v2?" + new URLSearchParams({
        action: "chat",
        message: prompt,
        chatId: "",
        sessionId: ""
    ...
    if (!result?.reply) throw new Error("AI API tidak mengembalikan jawaban.");
    return result.reply;
}
